...
public final class ModBlocks {
    ...
    public static final DeferredBlock<StairBlock> BOOKSHELF_STAIRS = BLOCKS.register(
    ...
    public static final DeferredBlock<LinkingLecternBlock> LINKING_LECTERN = BLOCKS.register(Reference.BlockNames.LINKING_LECTERN,
            () -> new LinkingLecternBlock(
                    BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(5).sound(SoundType.WOOD)));

    public static final DeferredBlock<NaraBlock> NARA = BLOCKS.register(Reference.BlockNames.NARA,
            () -> new NaraBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
                    .strength(100.0F, 2400.0F).requiresCorrectToolForDrops()));

    public static final DeferredBlock<LinkTranslatorBlock> LINK_TRANSLATOR = BLOCKS.register(Reference.BlockNames.LINK_TRANSLATOR,
    ...
    public static final DeferredBlock<LinkingPortalBlock> LINKING_PORTAL = BLOCKS.register(Reference.BlockNames.LINKING_PORTAL,
    ...
    public static final DeferredBlock<MarkerSwitchBlock> MARKER_SWITCH = BLOCKS.register(Reference.BlockNames.MARKER_SWITCH,
