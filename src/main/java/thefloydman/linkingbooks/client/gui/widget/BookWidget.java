...
public class BookWidget extends NestedWidget {
    ...
    public BookWidget(String id, int x, int y, float z, int width, int height, Component narration, Screen parentScreen,
        ...
        for (int i = 0; i < pages.size(); i++) {
            ...
            GuiBookPageWidget child = this.addChild(new GuiBookPageWidget("guidebook page " + i, localX, y + marginY,
                    ...
                    new TextComponent("Page " + i), parentScreen, 1.0F, font, page));
        ...
        this.previousArrow = this
                .addChild(new PageChangeWidget("back arrow", this.x + 16, this.y + this.getHeight() - 21, iteratedZ++,
                        new TextComponent("Previous Page"), parentScreen, 1.0F, PageChangeWidget.Type.PREVIOUS));
        this.nextArrow = this.addChild(new PageChangeWidget("forward arrow", this.x + this.getWidth() - 18 - 16,
                this.y + this.getHeight() - 21, iteratedZ++, new TextComponent("Next Page"), parentScreen, 1.0F,
    ...
    public void previousPage() {
        ...
        minecraft.player.playSound(ModSounds.PAGEFLIP_BACK.get(), 1.0F, 1.0F);
    }
    ...
    public void nextPage() {
        ...
        updateVisible();
        Minecraft minecraft = Minecraft.getInstance();
        minecraft.player.playSound(ModSounds.PAGEFLIP_FORWARD.get(), 1.0F, 1.0F);
    }
