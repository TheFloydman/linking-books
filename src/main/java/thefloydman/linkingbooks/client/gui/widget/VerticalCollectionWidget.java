    ...
    public VerticalCollectionWidget(String id, int x, int y, float z, int width, int height, Component narration,
        ...
        for (int i = 0; i < preparedElements.size(); i++) {
            ...
            if (object instanceof GuidebookParagraph) {
                ...
                this.addChild(new ParagraphWidget(this.id + "paragraph" + i, this.x, currentY, z + 1.0F, this.width,
                        paragraph.renderable.size() * lineSpacing, Component.literal("Paragraph"), parentScreen, 0.5F,
                ...
                this.addChild(new ImageWidget(this.id + "image" + i, this.x, currentY, z + 1.0F, this.width,
                        (int) scaledHeight, Component.literal("Image"), parentScreen, 1.0F, image.resourceLocation,
                ...
                this.addChild(new RecipeWidget(this.id + "recipe" + i,
                        (int) (this.x + ((this.width - (gridWidth * 0.5F)) / 2.0F)), currentY, z + 1.0F, this.width,
                        gridHeight, Component.literal("Recipe"), parentScreen, 0.5F, recipe.renderable));
